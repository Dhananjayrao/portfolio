    ...
    useEffect(()=>{
        ...
        {entries.forEach((entry)=>{
            if (entry.isIntersecting){
                if (entry.target === pyref.current || entry.target===reactref.current || entry.target===tsref.current || entry.target===javaref.current || entry.target===jsref.current || entry.target===nextref.current || entry.target===htmlref.current || entry.target===cssref.current){
        ...
        observer.observe(pyref.current)
     ...
     return (
        <div id={compid} className='section-bg'>
            <h2>{title}</h2>
            <div className='skills-bg'>
                <div ref={pyref} className='logo logo-dim logo-hidden'>
                ...
                <div ref={reactref} className='logo logo-dim logo-hidden'>
                ...
                <div ref={tsref} className='logo logo-dim logo-hidden'>
                ...
                <div ref={javaref} className='logo logo-dim logo-hidden'>
                ...
                <div ref={jsref} className='logo logo-dim logo-hidden'>
                ...
                <div ref={nextref} className='logo logo-dim logo-hidden'>
                ...
                <div ref={htmlref} className='logo logo-dim logo-hidden'>
                ...
                <div ref={cssref} className='logo logo-dim logo-hidden' >
